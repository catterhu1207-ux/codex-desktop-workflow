...
`v0.2.1` changes distribution, installer, and documentation only. The launcher artifact hashes and two-run runtime evidence below remain the current version-bound acceptance record.
