...
| `src/hotfix_profile_*.py`, `src/frontend_contract_26915*.py`, `src/frontend_work_contract_26915*.py`, `src/composer_selector_contract.py` | Author-owned version-profile chain used by the extracted builder; the public CLI enables `26.908.9136.0`, `26.915.3509.0` and `26.915.4065.0` | MIT, author-owned |
