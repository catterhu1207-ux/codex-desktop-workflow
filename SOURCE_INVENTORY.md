...
| `src/hotfix_profile_*.py`, `src/frontend_contract_*.py`, `src/frontend_work_contract_*.py`, `src/frontend_row_contract_*.py`, `src/composer_selector_contract.py` | Author-owned version-profile chain used by the extracted builder; the public CLI enables `26.908.9136.0`, `26.915.3509.0`, `26.915.4065.0`, `26.917.6896.0`, `26.917.9434.0`, and `26.924.1866.0` | MIT, author-owned |
